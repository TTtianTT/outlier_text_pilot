...
|---|---|---:|---:|---:|---:|
| test | outlier | 0 / 30 | 0.0000 | NA | 0.0000 |
| test | matched | 0 / 30 | 0.0000 | NA | 0.0000 |
| test | random | 0 / 30 | 0.0000 | NA | 0.0000 |
| test | nearest | 0 / 30 | 0.0000 | NA | 0.0000 |
| ood | outlier | 0 / 30 | 0.0000 | NA | 0.0000 |
| ood | matched | 0 / 30 | 0.0000 | NA | 0.0000 |
| ood | random | 0 / 30 | 0.0000 | NA | 0.0000 |
| ood | nearest | 0 / 30 | 0.0000 | NA | 0.0000 |
...
- dev: {'caliper_match_failed': 4, 'ok': 1, 'too_few_eligible': 25}
- test: {'caliper_match_failed': 3, 'too_few_eligible': 27}
- ood: {'caliper_match_failed': 10, 'too_few_eligible': 20}

## Shared preprocessing cost

Generation attempts: 2880.
Generated tokens (including rejected candidates): 37386.
Generation + feature + quality seconds: 723.12.
